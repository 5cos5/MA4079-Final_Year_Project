import numpy as np
from model_check import trip_split, find_time_slack, check_insertion_linear
...
def best_insertion(routes,data,initial_data,parameters):
    ...
    while len(unserved_cust) > 0:
        ...
        for a in sorted_list:
            ...
            trip = route[r]
            if check_insertion_linear(time2,time_slack2,time_adjustment_list2,demand_slack2,route,trip,k,r,i,cust,data,initial_data,parameters):
                trip.insert(i,cust)
                prev_k = k
                prev_r = r
                prev_i = i
