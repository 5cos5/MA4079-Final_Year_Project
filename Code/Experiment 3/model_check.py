...
def check_insertion_constant(time,time_slack,time_adjustment,demand_slack,route,trip,k,r,i,cust,data,initial_data,parameters,log = False, THRESHOLD = 0.000001):
